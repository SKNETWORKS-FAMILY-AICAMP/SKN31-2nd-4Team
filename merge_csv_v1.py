...
#   ./data/transactions_v1_processed.csv
#
# 출력:
...
transactions = pd.read_csv('./data/transactions_v1_processed.csv')
...
df = df.merge(transactions,    on='msno', how='inner')
...
df.to_csv('./data/merged_dataset_v1.csv', index=False)
